...
const zonas = {
  'blue': {
    name: 'Zona azul',
    bloques: [
      { minutos: 5, timeInSeconds: 300, priceInCents: 20, commissionPriceInCents: 5 },
      { minutos: 10, timeInSeconds: 600, priceInCents: 30, commissionPriceInCents: 10 },
  ...
  'green': {
    name: 'Zona verde',
    bloques: [
      { minutos: 5, timeInSeconds: 300, priceInCents: 35, commissionPriceInCents: 4 },
      { minutos: 10, timeInSeconds: 600, priceInCents: 55, commissionPriceInCents: 8 },
      { minutos: 15, timeInSeconds: 900, priceInCents: 75, commissionPriceInCents: 18 }
    ],
